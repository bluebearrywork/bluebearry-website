...
(function () {
  ...
  (function () {
    ...
    var zh = {
      "meta.title": "Live2DCursor — 让你的 Live2D 模型活在桌面上",
      "meta.description": "Live2DCursor 是一款轻量级原生 C++ Live2D 桌面伴侣：锚点跟随鼠标、拖拽物理反馈、表情热键绑定、OBS 友好背景模式，支持 6 大主题与 5 国语言。",
      "nav.features": "功能",
      "nav.how": "工作原理",
      "nav.themes": "主题",
      "nav.languages": "语言",
      "nav.steamCta": "在 Steam 上获取",
      "hero.eyebrow": "原生 C++ 桌面伴侣",
      "hero.sub": "桌面伴侣",
      "hero.desc": "把任意 Live2D 模型钉在桌面上——锚点自动锁定视线、拖拽出弹性物理、键鼠一键触发表情。轻量、常驻、直播友好，你的数字搭档静静住在桌面上。",
      "hero.cta": "⬇ 在 Steam 上获取",
      "hero.stat1": "内置主题",
      "hero.stat2": "语言本地化",
      "hero.stat3": "键 Steam 安装",
      "mock.title": "Live2DCursor 控制面板",
      "mock.models": " 模型 (1)：仅显示当前选中的模型",
      "mock.transparent": " 透明背景",
      "mock.ontop": " 置顶显示",
      "mock.bg": " 背景模式 (OBS)",
      "mock.follow": " 鼠标跟随",
      "mock.drag": " 拖拽物理",
      ...
      "features.f1.desc": "自动检测、点击选择或按 ArtMesh ID 搜索，精准锁定模型的“注视点”，让视线始终追随鼠标。",
      "features.f2.title": "拖拽物理效果",
      "features.f2.desc": "拖动模型时触发弹性物理反馈，增益强度实时可调，甩动起来软萌又有分量感。",
      ...
      "how.s2.title": "设定锚点",
      "how.s2.desc": "自动检测或点击选择锚点，模型的视线与身体从此追随鼠标移动。",
      "how.s3.title": "绑定热键",
      "how.s3.desc": "为表情、置顶、覆盖模式配置快捷键，剩下的交给桌面上的它。",

...
(function () {
  ...
  (function () {
    ...
    var zh = {
      ...
      "team.meta.title": "Live2D Cursor — 认识 Bluebearry 团队",
      "team.meta.description": "Bluebearry 是一个专注打造 Live2D Cursor 的两人独立团队。认识我们的 Live2D 模型师与程序开发者，欢迎联系 bluebearry.work@gmail.com。",
      ...
      "team.dev.role": "程序开发",
      "team.dev.name": "程序员",
      "team.dev.bio": "经验丰富的 C++ 工程师，深耕实时图形与底层系统开发。基于原生 Cubism SDK 从零打造 Live2D Cursor，对每一帧的性能都反复打磨，只为让你的模型运行得流畅、跟手、够轻量。",
      "team.dev.tag1": "原生 C++",
      "team.dev.tag2": "实时渲染",
